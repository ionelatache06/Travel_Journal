package ionela.com.traveljournalapp.recyclerView;
...
public class TripsAdapter extends FirestoreAdapter<TripsViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ionela.com.traveljournalapp.recyclerView.TripsViewHolder tripsViewHolder, final int i) {
